...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminCSE/cse/add"></c:url>
        <form:form method="post" action="${action}" commandName="cse">

            <table border="1" align="center">
                <c:if test="${!empty cse.name}">
        ...
        <h2 align="center">Result of CSE </h2>
        <c:if test="${!empty listCse}">
            <table border="1" align="center">
                ...
                <c:forEach items="${listCse}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminCSE/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteCse(${p.id})">Delete</a>
