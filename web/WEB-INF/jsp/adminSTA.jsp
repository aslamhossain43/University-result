...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminSTA/sta/add"></c:url>
        <form:form method="post" action="${action}" commandName="sta">

            <table border="1" align="center">
                <c:if test="${!empty sta.name}">
        ...
        <h2 align="center">Result of Statistics </h2>
        <c:if test="${!empty listSta}">
            <table border="1" align="center">
                ...
                <c:forEach items="${listSta}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminSTA/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteSta(${p.id})">Delete</a>
