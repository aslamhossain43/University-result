...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminMAT/mat/add"></c:url>
        <form:form method="post" action="${action}" commandName="mat">

            <table border="1" align="center">
                <c:if test="${!empty mat.name}">
        ...
        <h2 align="center">Result of Mathematics </h2>
            ...
            <table border="1" align="center">
                ...
                <c:forEach items="${listMat}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminMAT/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteMat(${p.id})">Delete</a>
