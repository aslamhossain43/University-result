...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminPHY/phy/add"></c:url>
        <form:form method="post" action="${action}" commandName="phy">

            <table border="1" align="center">
                <c:if test="${!empty phy.name}">
            ...
            <table border="1" align="center">
                ...
                <c:forEach items="${listPhy}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminPHY/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deletePhy(${p.id})">Delete</a>
