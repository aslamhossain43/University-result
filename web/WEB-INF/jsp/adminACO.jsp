...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminACO/aco/add"></c:url>
        <form:form method="post" action="${action}" commandName="aco">

            <table border="1" align="center">
                <c:if test="${!empty aco.name}">
        ...
        <h2 align="center">Result of Acounting </h2>
            ...
            <table border="1" align="center">
                ...
                <c:forEach items="${listAco}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminACO/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteAco(${p.id})">Delete</a>
