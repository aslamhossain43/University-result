...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminAR/ar/add"></c:url>
        <form:form method="post" action="${action}" commandName="ar">

            <table border="1" align="center">
                <c:if test="${!empty ar.name}">
        ...
        <h2 align="center">Result of Architecture </h2>
            ...
            <table border="1" align="center">
                ...
                <c:forEach items="${listAr}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminAR/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteAr(${p.id})">Delete</a>
