...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminFIN/fin/add"></c:url>
        <form:form method="post" action="${action}" commandName="fin">

            <table border="1" align="center">
                <c:if test="${!empty fin.name}">
        ...
        <h2 align="center">Result of Finance </h2>
        <c:if test="${!empty listFin}">
            <table border="1" align="center">
                ...
                <c:forEach items="${listFin}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminFIN/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteFin(${p.id})">Delete</a>
