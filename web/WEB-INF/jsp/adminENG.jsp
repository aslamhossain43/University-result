...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminENG/eng/add"></c:url>
        <form:form method="post" action="${action}" commandName="eng">

            <table border="1" align="center">
                <c:if test="${!empty eng.name}">
        ...
        <h2 align="center">Result of English </h2>
        <c:if test="${!empty listEng}">
            <table border="1" align="center">
                ...
                <c:forEach items="${listEng}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminENG/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteEng(${p.id})">Delete</a>
