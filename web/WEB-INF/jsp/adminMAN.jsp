...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminMAN/man/add"></c:url>
        <form:form method="post" action="${action}" commandName="man">
        ...
        <h2 align="center">Result of Managment </h2>
        <c:if test="${!empty listMan}">
            <table border="1" align="center">
                ...
                <c:forEach items="${listMan}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminMAN/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteMan(${p.id})">Delete</a>
