...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminSOC/soc/add"></c:url>
        <form:form method="post" action="${action}" commandName="soc">

            <table border="1" align="center">
                <c:if test="${!empty soc.name}">
        ...
        <h2 align="center">Result of Sociology </h2>
        <c:if test="${!empty listSoc}">
            <table border="1" align="center">
                ...
                <c:forEach items="${listSoc}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminSOC/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteSoc(${p.id})">Delete</a>
