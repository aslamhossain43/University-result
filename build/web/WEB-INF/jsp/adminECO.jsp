...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminECO/eco/add"></c:url>
        <form:form method="post" action="${action}" commandName="eco">

            <table border="1" align="center">
                <c:if test="${!empty eco.name}">
        ...
        <h2 align="center">Result of Economics </h2>
        <c:if test="${!empty listEco}">
            <table border="1" align="center">
                ...
                <c:forEach items="${listEco}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminECO/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteEco(${p.id})">Delete</a>
