...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminCHE/che/add"></c:url>
        <form:form method="post" action="${action}" commandName="che">

            <table border="1" align="center">
                <c:if test="${!empty che.name}">
        ...
        <h2 align="center">Result of Chemistry </h2>
        <c:if test="${!empty listChe}">
            <table border="1" align="center">
                ...
                <c:forEach items="${listChe}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminCHE/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteChe(${p.id})">Delete</a>
