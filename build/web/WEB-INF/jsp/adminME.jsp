...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminME/me/add"></c:url>
        <form:form method="post" action="${action}" commandName="me">
        ...
        <h2 align="center">Result of Mechanical Engineering </h2>
        <c:if test="${!empty listMe}">
            <table border="1" align="center">
                ...
                <c:forEach items="${listMe}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminME/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteMe(${p.id})">Delete</a>
