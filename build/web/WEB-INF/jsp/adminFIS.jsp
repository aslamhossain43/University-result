...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminFIS/fis/add"></c:url>
        <form:form method="post" action="${action}" commandName="fis">

            <table border="1" align="center">
                <c:if test="${!empty fis.name}">
        ...
        <h2 align="center">Result of Fisheries </h2>
        <c:if test="${!empty listFis}">
            <table border="1" align="center">
                ...
                <c:forEach items="${listFis}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminFIS/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteFis(${p.id})">Delete</a>
