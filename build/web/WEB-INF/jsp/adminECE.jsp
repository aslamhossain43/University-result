...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminECE/ece/add"></c:url>
        <form:form method="post" action="${action}" commandName="ece">

            <table border="1" align="center">
                <c:if test="${!empty ece.name}">
        ...
        <h2 align="center">Result of ECE </h2>
        <c:if test="${!empty listEce}">
            <table border="1" align="center">
                ...
                <c:forEach items="${listEce}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminECE/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteEce(${p.id})">Delete</a>
