...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminAE/ae/add"></c:url>
        <form:form method="post" action="${action}" commandName="ae">

            <table border="1" align="center">
                <c:if test="${!empty ae.name}">
        ...
        <h2 align="center">Result of Agriculture Engineering </h2>
        <c:if test="${!empty listAe}">
            <table border="1" align="center">
                ...
                <c:forEach items="${listAe}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminAE/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteAe(${p.id})">Delete</a>
