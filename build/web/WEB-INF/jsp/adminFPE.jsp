...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminFPE/fpe/add"></c:url>
        <form:form method="post" action="${action}" commandName="fpe">

            <table border="1" align="center">
                <c:if test="${!empty fpe.name}">
        ...
        <h2 align="center">Result of FPE </h2>
        <c:if test="${!empty listFpe}">
            <table border="1" align="center">
                ...
                <c:forEach items="${listFpe}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminFPE/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteFpe(${p.id})">Delete</a>
