...
<html>
    ...
    <body style="background-color:greenyellow; margin-top: 0px;margin-left: 0px;">
        <c:url var="action" value="/adminEEE/eee/add"></c:url>
        <form:form method="post" action="${action}" commandName="eee">

            <table border="1" align="center" >
                <c:if test="${!empty eee.name}">
        ...
        <h2 align="center">Result of EEE </h2>
        <c:if test="${!empty listEee}">
            <table border="1" align="center">
                ...
                <c:forEach items="${listEee}" var="p">
                    ...
                    <tr>
                        ...
                        <td><a href="/WebApplicationMVC_Project2/adminEEE/edit/${p.id}">Edit</a>
                           <a href="%" onclick="javascript:deleteEee(${p.id})">Delete</a>
